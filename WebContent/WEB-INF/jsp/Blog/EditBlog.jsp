		...
		<div style="padding-top: 80px; padding-left: 300px">			
				<div class="Biaoti">
					<input type="text" name="title" maxlength="100" class="Input_Biaoti"
						id="Input_Biaoti" style="width:800px;" value="${BlogTitle }">
				</div>
		</div>
		<div style="padding-left: 300px">
				<div id="test-editormd" class="test-edit">
					<script name="content" id="editor" type="text/plain"
						style="width:800px;height:300px;">${BlogContent }</script>
				</div>
				<input type="text" style="display:none" name="blogtraffic" value="${Blogtraffic }">
				<div class="Button">
					<input type="submit" value="确认修改" name="submit"> <input
