...
<body style="background-color:rgb(210,216,222)">
		...
		<div data-v-357a65ed="" class="view-container">
			<div data-v-0c56b7f6="" data-v-357a65ed="" class="content view">
				<div data-v-0c56b7f6="" class="bar" style="padding-left:30px;">					
					<h3 data-v-0c56b7f6="" style="padding-left:10px;" class="title">我的关注</h3>
	...
	<div style="padding-left:550px;">
       	<a href="${pageContext.request.contextPath }/follow/${UserNumber }?UserName=${UserName }&page=${ProPage }" class="previous" style=" background-color: #f1f1f1;color: black;text-decoration: none;display: inline-block;padding: 8px 16px;">&laquo; 上一页</a>
		<a href="${pageContext.request.contextPath }/follow/${UserNumber }?UserName=${UserName }&page=${NextPage }" class="next" style=" background-color: #f1f1f1;color: black;text-decoration: none;display: inline-block;padding: 8px 16px;">下一页 &raquo;</a>
    </div>
</body>
</html>