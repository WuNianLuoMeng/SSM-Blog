...
/**
 * 
* <p>Title: AllBlogController.java<／p>
* <p>Description: 查询所有博客Controller<／p>
* @author Ma
* @date 2019年5月23日
 */
@Controller
public class AllBlogController {
	...
	public String allblog(String UserName,String UserNumber,ModelMap model,@RequestParam(value="page",defaultValue = "1") int page) throws Exception{
